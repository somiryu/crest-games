...
public class DialoguesDisplayerUI : MonoBehaviour
{
    ...
    public void OnClickResponse(DialogueResponse responseClicked)
    {
        ...
        {
			currResponseAudio = UserDataManager.CurrUser.sex == UserSex.Mujer ? responseClicked.responseAudioAlternative : responseClicked.responseAudio;
		}
    ...
    {
        var text = curr.text;
        if(UserDataManager.CurrUser.sex == UserSex.Mujer && !string.IsNullOrEmpty(curr.textAlternative))
        {
    ...
    public AudioClip SelectAudioByGender(DialogueData curr)
    {
        ...
        if(UserDataManager.CurrUser.sex == UserSex.Mujer && curr.audioAlternative != null)
        {
